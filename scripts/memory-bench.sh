...
run_suite() {
  ...
  run_scenario low-batch SUPERMEMORY_LOCAL_EMBEDDING_BATCH_SIZE=2 SUPERMEMORY_INGEST_CONCURRENCY=1 SUPERMEMORY_EMBEDDING_RAM_LIMIT=256mb >> "$results_file" || true
  printf '%s\n' "$results_file"
}
